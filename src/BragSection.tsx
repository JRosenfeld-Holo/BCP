...
export function BragWall() {
  return (
    <section id="proof" className="py-32 px-6 md:px-12 border-t border-white/5">
      <div className="mb-16 border-l-2 border-[#2563EB] pl-6">
        <h2 className="text-[10px] uppercase tracking-widest accent-text mb-4">02 // Receipts</h2>
